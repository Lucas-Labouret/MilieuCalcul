...
class DelaunayTriangulationAction extends RecursiveAction {
    ...
    OptionalInt getCandidate(int leftBase, int rightBase, Side s) {
        ...
        switch (s) {
            case RIGHT:
                angleWithBase = (Point point) -> GeometricPrimitives.getAngle(leftVertex, rightVertex, point);
                break;

            case LEFT:
                angleWithBase = (Point point) -> GeometricPrimitives.getAngle(point, leftVertex, rightVertex);
                break;
